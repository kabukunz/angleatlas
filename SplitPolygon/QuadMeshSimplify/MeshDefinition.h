...
//#include <OpenMesh/Core/MyMesh/TriMesh_ArrayKernelT.hh>
...
typedef OpenMesh::PolyMesh_ArrayKernelT<MeshTraits> MyMesh;

bool is_flip_ok_openmesh(MyMesh::EdgeHandle& eh, MyMesh& mesh_);//just copy the code from openmesh
