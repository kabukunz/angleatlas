...
void InteractiveViewerWidget::polysquare()
{
...
void InteractiveViewerWidget::quad_cutting()
{
	if (para_cutting == nullptr) return;
...
void InteractiveViewerWidget::distortion_reduce()
{
	if (para_cutting == nullptr) return;
...
void InteractiveViewerWidget::pre_process()
{
	mirror_neg_charts();
	select_cut_bridges();
	spilt_seleted_edges();
...
void InteractiveViewerWidget::my_process()          //批量处理
{
