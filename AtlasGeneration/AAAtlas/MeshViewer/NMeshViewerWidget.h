...
// 	void updateMeshSignal();
// 	void updateEdgeSignal(double, double, double);
// 	void updateFaceSignal(double, double, double);
...
public:
	...
	Mesh::Scalar mesh_avg_length, edge_offset;
