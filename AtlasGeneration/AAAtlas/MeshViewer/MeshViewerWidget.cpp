...
void MeshViewerWidget::square_widget()
{
	int w = width();
	int h = height();
...
// 	}
	...
	for (auto e_h : mesh.edges())
	{
		if (mesh.is_boundary(e_h) || !mesh.property(e_oncut, e_h)) continue;
...
#ifndef FLAT_COLORING
	GLfloat mat_a[] = { 0.5f, 1.0f, 0.83f, 1.0f };
	GLfloat mat_d[] = { 0.396f, 0.74151f, 0.69102f, 1.0f };
	GLfloat mat_s[] = { 0.297254f, 0.30829f, 0.306678f, 1.0f };
