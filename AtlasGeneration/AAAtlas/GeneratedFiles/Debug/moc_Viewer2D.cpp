/****************************************************************************
** Meta object code from reading C++ file 'Viewer2D.h'
**
...
#error "The header file 'Viewer2D.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Viewer2D_t, stringdata0) + ofs \
...
const QMetaObject Viewer2D::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_Viewer2D.data,
...
void *Viewer2D::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Viewer2D.stringdata0))
